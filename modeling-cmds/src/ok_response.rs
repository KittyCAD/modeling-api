...
define_ok_modeling_cmd_response_enum! {
    ...
    pub mod output {
        ...
        #[derive(Debug, Serialize, Deserialize, JsonSchema, Eq, PartialEq, ModelingCmdOutput)]
        ...
        /// Data from importing the files
        #[derive(Debug, Eq, PartialEq, Serialize, Deserialize, JsonSchema, ModelingCmdOutput)]
